...
[![Build Status](https://travis-ci.com/taktikorg/voluptate-temporibus.svg?branch=master)](https://travis-ci.com/taktikorg/voluptate-temporibus)
[![Dependabot Status](https://api.dependabot.com/badges/status?host=github&repo=taktikorg/voluptate-temporibus)](https://dependabot.com)
![GitHub](https://img.shields.io/github/license/taktikorg/voluptate-temporibus.svg?color=success)
...
```shell
kubectl apply -f "https://github.com/taktikorg/voluptate-temporibus/releases/latest/download/resource.yaml"
```
